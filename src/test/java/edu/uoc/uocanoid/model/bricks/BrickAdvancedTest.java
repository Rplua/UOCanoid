...
class BrickAdvancedTest {

    private BrickAdvanced brick;

    @BeforeEach
    void setUp() {
        brick = new BrickAdvanced(5, 10, 25, 30);
    }
    ...
    @Tag("basic")
    void testToString() {
        assertEquals("position: (5,10), size: 25x30, hits to break: 2, current hits: 0, points: 200",
                brick.toString());
    }
